...
var assetsPluginInstance = new AssetsPlugin({ path: path.join(__dirname, 'angular2-frontend') });
...
module.exports = {
    ...
    entry: {
        'vendor': './angular2-frontend/src/vendor.ts',
        'app': './angular2-frontend/src/bootstrap.ts' // our angular app
    },
